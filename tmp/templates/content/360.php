<figure>
  <a href='<?php echo base_url ($now);?>'>
    <img alt='<?php echo title ($title);?>' src='<?php echo image_url ('article', $now, 'banner.jpg');?>' />
  </a>
  <figcaption><?php echo title ($title);?></figcaption>
</figure>

<h2>
  <a href='<?php echo base_url ($now);?>'>全景相簿 Theta 360 實作心得</a>
...
<article>
  ...
  <p><a class='n' href='http://360.ioa.tw/b21470101e21cb202b8563a7a9e034b8' target='_blank'><img alt='<?php echo title ($title);?>' src='<?php echo image_url ('article', '360', '01.jpg');?>' /></a><br/>▲ 360度的相片原始檔</p>
  <br/>
  
  <p><a class='n' href='http://360.ioa.tw/b21470101e21cb202b8563a7a9e034b8' target='_blank'><img alt='<?php echo title ($title);?>' src='<?php echo image_url ('article', '360', '02.png');?>' /></a><br/>▲ 360度全景相片播放器 呈現的方式</p>
  <br/>
