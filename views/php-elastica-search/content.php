...
<ul>
  ...
  <li>經由各種類別方法(static)，對 Elastica Search 實作 <a href='https://works.ioa.tw/OA-ElasticaSearch/guide/create.html' target='_blank'>新增</a>、<a href='https://works.ioa.tw/OA-ElasticaSearch/guide/read.html' target='_blank'>查詢</a>、<a href='https://works.ioa.tw/OA-ElasticaSearch/guide/update.html' target='_blank'>修改</a>、<a href='https://works.ioa.tw/OA-ElasticaSearch/guide/delete.html' target='_blank'>刪除</a> 的操作。</li>
  ...
  <li>CRUD 範例，將會以 Type User 作為範例說明，詳細結構可以查閱 <a href='https://works.ioa.tw/OA-ElasticaSearch/guide/struct.html' target='_blank'>結構說明</a>。</li>
