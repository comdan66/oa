...
<div class='pics'>
  <div class='pictures n2'>
    <figure href='<?php echo base_url ($current['file'] . EXTENSION);?>'>
      <img alt="使用 JavaScript 去取得 Google 文件上的路徑資訊 <?php echo $alt;?>" src="<?php echo img_url ('views', $current['file'], '02.jpg');?>" />
      <figcaption data-description='使用 JavaScript 去取得 Google 文件上的路徑資訊'>使用 JavaScript 去取得 Google 文件上的路徑資訊</figcaption>
    </figure>
    <figure href='<?php echo base_url ($current['file'] . EXTENSION);?>'>
      <img alt="Google 文件上的路徑紀錄 <?php echo $alt;?>" src="<?php echo img_url ('views', $current['file'], '01.jpg');?>" />
      <figcaption data-description='Google 文件上的路徑紀錄'>Google 文件上的路徑紀錄</figcaption>
    </figure>
  </div>
</div>
<br />
