...
<p><img width='400' alt='<?php echo $alt;?>' src='<?php echo img_url ('articles', 'haotien-gps', '02.jpg');?>' /><br/>▲ 使用 JavaScript 去取得 Google 文件上的路徑資訊</p>
<p><img width='400' alt='<?php echo $alt;?>' src='<?php echo img_url ('articles', 'haotien-gps', '01.jpg');?>' /><br/>▲ Google 文件上的路徑紀錄</p>
