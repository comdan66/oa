...
<p><img width='800' alt='<?php echo $alt;?>' src='<?php echo img_url ('articles', 'img-liquid', '01.jpg');?>' /><img width='800' alt='<?php echo $alt;?>' src='<?php echo img_url ('articles', 'img-liquid', '02.jpg');?>' /><br/>▲ 垂直、水平置中(藍色為父層、黃色為 img 元素)</p>
<br/>
