...
<p><a class='n' href='https://github.com/comdan66/catmap_ios' target='_blank'><img width='800' alt="<?php echo $alt;?>" src='<?php echo img_url ('views', $current['file'], '01.jpg');?>' /></a><br/>▲ CatMap 主要個頁面</p>
<br />
