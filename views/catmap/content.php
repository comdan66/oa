...
<div class='pics'>
  <div class='pictures n2'>
    <figure href='<?php echo base_url ($current['file'] . EXTENSION);?>'>
      <img alt="CatMap 登入以及主畫面 <?php echo $alt;?>" src="<?php echo img_url ('views', $current['file'], '02.jpg');?>" />
      <figcaption data-description='CatMap 登入以及主畫面'>CatMap 登入以及主畫面</figcaption>
    </figure>
    <figure href='<?php echo base_url ($current['file'] . EXTENSION);?>'>
      <img alt="CatMap 地圖以及設定頁面 <?php echo $alt;?>" src="<?php echo img_url ('views', $current['file'], '03.jpg');?>" />
      <figcaption data-description='CatMap 地圖以及設定頁面'>CatMap 地圖以及設定頁面</figcaption>
    </figure>
  </div>
</div>
<br />
