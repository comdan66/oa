...
<?php }?>
  ...
  <body lang="zh-tw">
    <div class='_scope' itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
      <a itemprop="url" href='<?php echo base_url ();?>'><span itemprop="title"><?php echo OA;?></span></a>
    </div>
    <div class='_scope' itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
    ...
    <?php foreach ($_menus as $menus) { ?>
        ...
        <?php foreach ($menus['items'] as $item) {
                if (in_array ($item['type'], array ('demo', 'more', 'article', 'albums', 'album', 'unpacking', 'search'))) { ?>
