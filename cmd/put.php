...
Step::setUploadDirs (array (
    'assets' . DIRECTORY_SEPARATOR . 'js' => array ('js'),
    'assets' . DIRECTORY_SEPARATOR . 'css' => array ('css'),
    'assets' . DIRECTORY_SEPARATOR . 'font' => array ('eot', 'svg', 'ttf', 'woff'),
    'assets' . DIRECTORY_SEPARATOR . 'img' => array ('png', 'jpg', 'jpeg', 'gif', 'svg'),
    'sitemap' => array ('xml'),
    '' => array ('html', 'txt')
  ));
// ---------------
