...
return array (
    array ('group' => '基本資料', 'title' => '', 'items' => array (
        array (
            ...
            'text' => '關於 OA',
            'file' => 'index',
            'keywords' => array ('iOA', 'OA', 'OA Wu', '吳政賢', 'php', 'Java', 'JavaScript', 'MySQL', 'HTML', 'css', 'compass', 'scss', 'Node.js', 'Ruby on Rails', 'Apache', 'Linux', 'AWS'),
            'tags' => array (),
            'created_at' => '1989-07-21 00:00:00',
            'updated_at' => date ('Y-m-d H:i:s'),
            'description' => "Hi，您好！歡迎點閱我的網站，我叫吳政賢，這裡是一個紀錄我個人作品、生活、技術的心得網站，站內收錄了我從淡江大學以來多項作品與經驗，如果各位有興趣的話非常歡迎來信討論，作品文章中若有錯誤或爭議也歡迎指教喔。程式設計是我目前的主要工作，會讓我走上程式設計這條路是因為高中電腦課的程式設計產生了興趣，所以大學科系就選擇資訊工程，也因為資工系的課程內容讓我對電腦運算原理有了扎實的基礎概念，所以在學期間不僅是應用程式面的進步。因為喜愛程式實作，所以大學期間就做了各種實作練習，而在網站內也收錄了各個不同語言寫出來的作品，其中包含 C語言、Java、php、MySQL.. 等多項各種程式語言，當然不只有大學期間，其中更包括了畢業後職場生涯的經驗與相關技術知識的紀錄分享，以下會簡略的介紹這些不同時期的作品心得！家鄉雲林北港，或許是因為在這個文化古鎮長大，所以除了程式的興趣以外，我也很喜愛參與各個台灣本土的文化活動，例如：北港迎媽祖、淡水清水祖師.. 等，每次對於參與的文化活動我也喜歡背著相機逐步的跟隨，記錄著我認為美的影像。",
            'tabs' => array ('university')
          ),
        array ('type' => 'albums', 'text' => 'OA 的相簿', 'file' => 'albums', 'sub' => array (
            array (
                'type' => 'album',
                'file' => '2016-0425-beigang-mazu',
                'text' => '2016年 北港迎媽祖',
            ...
            array (
                ...
                'text' => '淡水天元宮',
                'keywords' => array ('淡水', '天元宮', '淡水天元宮', '櫻花'),
                'tags' => array ('淡水', '天元宮', '櫻花'),
                'description' => "淡水天元宮",
            ...
            array (
                ...
                'keywords' => array ('北港', '媽祖盃', '21km', '半馬路跑', '半馬', '路跑'),
                'tags' => array ('北港', '21km', '半馬', '路跑'),
                'description' => "北港媽祖盃 21km 半馬路跑",
                'created_at' => '2015-06-07 00:00:00',
            ...
            array (
                ...
                'text' => '[自製]60元筆電散熱架',
                'keywords' => array ('自製', '散熱架', '筆電散熱架'),
                'tags' => array ('自製', '散熱架'),
                'description' => "[自製]60元筆電散熱架",
                'created_at' => '2014-08-30 00:00:00',
            ...
            array (
                ...
                'text' => '被融化的火紅老街',
                'keywords' => array ('淡水', '淡水老街', '老街'),
                'tags' => array ('淡水', '老街'),
                'description' => "被融化的火紅老街",
                'created_at' => '2014-03-23 00:00:00',
            ...
            array (
                ...
                'text' => '冬季綻放奇蹟之櫻',
                'keywords' => array ('淡水', '淡水老街', '綻放', '櫻花'),
                'tags' => array ('淡水', '櫻花'),
                'description' => "冬季綻放奇蹟之櫻",
                'created_at' => '2013-02-02 00:00:00',
                'updated_at' => '2013-02-02 23:59:59',
                'updated_at' => date ('Y-m-d H:i:s'),
        ...
        array (
            ...
            'updated_at' => date ('Y-m-d H:i:s'),
            'description' => "快速關鍵字搜尋相關實作、生活、經驗文章吧！這裡面集合了所有文章、相簿，提供給大家搜尋，想找尋所有文章的話，可以輸入 all 即可找出所有資料喔！",
          ),
      )),
    array ('group' => '網頁<span>全端</span>作品', 'title' => '(php、JavaScript、MySQL、CSS)', 'items' => array (
        array (
            ...
            'file' => 'mazu',
            'text' => '北港迎媽祖',
            'keywords' => array ('北港迎媽祖', '北港', '迎媽祖', '北港媽祖', 'Material Design'),
            'tags' => array ('Material', 'php7', 'Google Maps', 'TinyPNG', 'JSON-LD', 'schema', 'AWS EC2', 'AWS S3', 'iOS', 'GPS'),
            'description' => '北港迎媽祖，這是個為我的家鄉的活動製作網站，幾本上是屬於義務性幫忙、沒盈利的非官方服務。每年我都會在<b>北港農曆三月十九迎媽祖</b>前數個月開始製作，目前為止這網站我算是不斷自我突破吧！整體從 <b>設計</b>、<b>後端</b>、<b>系統</b>、<b>切版</b>、<b>攝影</b>、<b>上稿</b>，基本上都是我嘗試一個人完成！',
            'created_at' => '2016-04-25 00:00:00',
            'updated_at' => date ('Y-m-d H:i:s'),
            'main_links' => array (
        ...
        array (
            ...
            'tags' => array ('AWS S3'),
            'description' => "這是項利用<a href='http://data.ntpc.gov.tw/' target='_blank'>新北市政府資料開放平台</a>提供的<a href='http://data.ntpc.gov.tw/od/detail?oid=781B822E-214A-4B9A-B4DB-32C9F4626D98' target='_blank'>新北市政府文化局藝文活動</a> API 所製作的台北 • 藝文活動。使用 <a href='https://zh.wikipedia.org/zh-tw/PHP' target='_blank'>php</a> 將 API 資料取下來後編輯成 <a href='https://zh.wikipedia.org/zh-tw/HTML' target='_blank'>HTML</a> 頁面，並且放置到 <a href='https://aws.amazon.com/tw/s3/' target='_blank'>Amazon S3</a>。放置部署過程中同時將頁面所需的 <a href='https://zh.wikipedia.org/wiki/层叠样式表' target='_blank'>css</a>、<a href='https://zh.wikipedia.org/wiki/JavaScript' target='_blank'>JavaScript</a> 一起上傳至 S3。",
        ...
        array (
            ...
            'keywords' => array ('JavaScript', '迷宮遊戲', 'JavaScript maze', 'maze',  'jQuery',  '迷宮遊戲',  '3D 視角',  'transform',  'rotateX',  'rotateY',  'translateZ',  '老鼠走迷宮'),
            'tags' => array ('JavaScript', 'jQuery'),
        ...
        array ('type' => 'more', 'text' => '更多全端作品..', 'file' => 'more-full-stack', 'sub' => array (
            ...
            array (
                ...
                'file' => 'github-blog',
                'text' => 'GitHub Blog',
                'keywords' => array ('GitHub.io', 'GitHub', 'php', 'Markdown', 'octopress', 'pelican', 'templates'),
                'tags' => array ('GitHub', 'Markdown'),
            ...
            array (
                ...
                'file' => 'instagram-maps',
                'text' => 'Instagram Maps',
                'keywords' => array ('instagram', 'MarkerClusterer', 'MarkerWithLabel', 'LatLngBounds'),
                'tags' => array ('Google Maps'),
            ...
            array (
                ...
                'tags' => array ('Google Maps', 'AWS EC2', 'AWS S3', 'GitHub'),
    ...
    array ('group' => 'iOS 工具、app 開發', 'title' => '', 'items' => array (
        array (
            ...
            'file' => 'catmap',
            'text' => 'CatMap',
            'keywords' => array ('REMarkerClusterer', 'AFNetworking', 'AsyncImageView', 'Instagram', 'Facebook'),
    ...
    array ('group' => '接案作品', 'title' => '', 'items' => array (
        ...
        array (
            ...
            'description' => "這是一個前端技術的外包案實作，其網站名稱為<a href='http://www.ntpc-childartfestival.com.tw/' target='_blank'>2016 新北市兒童藝術節</a>，主要就是承接新北市 2016年 兒童藝術節的活動官網。此活動網站最具特色的地方是動畫的呈現，大家可以先點至 <a href='https://sasachu.github.io/2016child/' target='_blank'>GitHub Demo</a> 瀏覽動畫效果喔！",
    ...
    array ('group' => 'Java 作品開發', 'title' => '', 'items' => array (
        array (
            ...
            'text' => '大一 Java 小畫家',
            'keywords' => array ('Java 小畫家', '小畫家', 'Java Painter', 'Painter', 'Java GUI', 'GUI'),
            'tags' => array ('Java'),
        ...
        array (
            ...
            'text' => '大二 Java MSN',
            'keywords' => array ('Java MSN', 'MSN', 'Java GUI', 'GUI'),
            'tags' => array ('Java'),
        ...
        array (
            ...
            'keywords' => array ('Java Assembler', 'Assembler', 'Java 組譯器', '組譯器', 'Java GUI', 'GUI'),
            'tags' => array ('Java', 'Assembler'),
        ...
        array (
            ...
            'keywords' => array ('Java Plurker', 'Plurker', 'Java Plurk', 'Plurk', 'Java 噗浪', '噗浪', 'Java GUI', 'GUI'),
            'tags' => array ('Java'),
    ...
    array ('group' => '其他', 'title' => '', 'items' => array (
        array (
            ...
            'keywords' => array ('新銳展翅創意競賽', '新銳展翅', '創意競賽', '競賽', 'Arduino UNO', 'UNO', 'xbee', '智慧型腳踏車'),
            'tags' => array ('Arduino', '競賽'),
        ...
        array (
            ...
            'file' => 'c-comic-book',
            'text' => 'C語言 漫畫下載器',
            'keywords' => array ('漫畫下載器', '漫畫', '下載器', '8comic', 'BBS'),
            'tags' => array ('C語言'),
        ...
        array (
            ...
            'created_at' => '2016-09-06 00:00:00',
            'updated_at' => date ('Y-m-d H:i:s'),
            'main_links' => array (
                // 'GitHub' => 'https://github.com/comdan66/c-comic-book',
              ),
