...
return array (
    array ('group' => '基本資料', 'title' => '', 'items' => array (
        array ('type' => 'article', 'text' => '關於 OA', 'file' => 'index'),
      )),
    array ('group' => '網頁<span>全端</span>作品', 'title' => '(php、JavaScript、MySQL、CSS)', 'items' => array (
        ...
        array ('type' => 'article', 'text' => 'maze 迷宮遊戲', 'file' => 'x'),

        array ('type' => 'list', 'text' => '更多全端作品..', 'file' => 'more-full-Stack', 'sub' => array (
            array ('type' => 'article', 'text' => 'GitHub Blog', 'file' => 'aaa'),
            array ('type' => 'article', 'text' => 'instagram_maps', 'file' => 'aaa'),
            array ('type' => 'article', 'text' => '大庄媽 GPS', 'file' => 'aaa'),
            array ('type' => 'article', 'text' => '六房媽祖 GPS', 'file' => 'aaa'),
            array ('type' => 'article', 'text' => '大四 php 相簿', 'file' => 'aaa'),
            array ('type' => 'article', 'text' => '大四 php 空間、部落格', 'file' => 'aaa'),
            array ('type' => 'article', 'text' => 'flickr 搜尋器', 'file' => 'x'),
            array ('type' => 'article', 'text' => 'u2 Youtube 播放器', 'file' => 'x'),
            array ('type' => 'article', 'text' => '大四 jQuery Game', 'file' => 'x'),
          )),
    ...
    array ('group' => 'JavaScript 套件、工具開發', 'title' => '', 'items' => array (
        ...
        array ('type' => 'list', 'text' => '更多 JavaScript 作品..', 'file' => 'more-full-Stack', 'sub' => array (
    ...
    array ('group' => '獨立接案', 'title' => '', 'items' => array (
        ...
        array ('type' => 'list', 'text' => '更多獨立接案作品..', 'file' => 'more-full-Stack', 'sub' => array (
