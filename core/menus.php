...
return array (
    ...
    array ('group' => '網頁<span>全端</span>作品', 'title' => '(php、JavaScript、MySQL、CSS)', 'items' => array (
        array (
            ...
            'pictures' => array (
                array ('name' => '01.jpg', 'text' => 'Google Maps 遶境路線圖', 'desc' => '整個網站的主軸，利用 Google Maps JavaScript API 來繪製動態的遶境路線圖，並且以動畫來意會活動當天的動線！'),
                array ('name' => '02.jpg', 'text' => '在地相關文獻', 'desc' => '手動編輯相關北港陣頭文獻資料，從高中、大學就累績的相關資料，經由北港前輩們提點修正的相關文獻，搭配自己攝影的相關紀錄照片，以圖文方式介紹北港。'),
                array ('name' => '03.jpg', 'text' => '北港景點資訊', 'desc' => '以 Google Maps 為主題，將北港有特色的店家、景點以地圖的方式呈現，並且以文章介紹其內容，或者提供相關部落客的網址，以提供網友來北港遊玩前的準備資訊。'),
                array ('name' => '04.jpg', 'text' => '北港三月十九 GPS', 'desc' => '北港農曆三月十九各陣頭 GPS 定位，有鑒於近年來北港廟會的時程都不斷延遲，於是便製作了一個可以追蹤目前相關陣頭的 GPS 位置，再搭配 Google Maps 來顯示並且可以有效管理與掌握！'),
                array ('name' => '10.jpg', 'text' => 'iOS GPS Tracker APP', 'desc' => '在各陣頭上放置此 App 即可在固定的時間區間回傳最新的定位資訊，App 並且可以鎖定以防止工作人員誤觸的風險。活動當天是使用 iPhone 4s 在香案車上使用充電器以保持穩定電量。'),
                array ('name' => '11.jpg', 'text' => '管理 APP', 'desc' => '活動當天管理人員必然會在外面忙碌，所以有關電腦的相關設定或者 GPS Tracker 狀態管理、聊天室的狀況，都做成手機 App，以達到有效的管理。'),
                array ('name' => '05.jpg', 'text' => '活動地圖搭配聊天室', 'desc' => '由於 AWS S3 架構方便、便宜、大頻寬，所以將其進階運用，使用 S3 來存放大量的聊天室內容，當使用者留言時，EC2 再將其資訊補至 S3，而聊天室每 10 秒再藉由 Ajax 往 S3 取得聊天室內容。'),
                array ('name' => '06.jpg', 'text' => '迎媽祖系統後台', 'desc' => '網站不只前台技術，後台也有多項 CRUD 的功，其中也包含了地圖編輯，後台人員可以自行的編輯遶境路線圖抑或者地圖資訊，此功能對於網站維護是一項重點任務。'),
                array ('name' => '07.jpg', 'text' => '文章編輯器', 'desc' => '網站除了地圖重點外，多項內容則是使用文章的方式顯示，所以文章編輯器是必備的一項功能。'),
                array ('name' => '08.jpg', 'text' => '大量的快取機制', 'desc' => '網站要撐住大流量不敗的第一項法則就是做快取，其中我將 output 的資訊全部大量的做成快取，當後台有修改資料再針對相關的頁面清除快取，抑或者每小時重置一次快取。而系統為加強效能問題，除了 output 快取外，也對 config、Model 做相關的優化快取。'),
                array ('name' => '09.jpg', 'text' => 'Server 只有一次 Request', 'desc' => '因為都將相關靜態檔案(css、img、js)都放置 S3，所以在網站上的 Request 數量大大降低，這對 Server 效能是一項有力的優化。'),
              )
          ),
        array (
            'type' => 'demo',
        ...
        array (
            ...
            'tags' => array ('LatLngBounds', 'Google Maps Polyline每 10 秒', 'Ajax 往 S3 取得聊天室內容', 'CodeIgniter。'),
        ...
        array ('type' => 'more', 'text' => '更多全端作品..', 'file' => 'more-full-stack', 'sub' => array (
            ...
            array (
                ...
                'file' => 'instagram-maps',
                'text' => 'Instagram Maps',
                'keywords' => array ('instagram', 'Google Maps', 'MarkerClusterer', 'MarkerWithLabel', 'LatLngBounds每 10 秒', 'Ajax 往 S3 取得聊天室內容。'),
